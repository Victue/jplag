...
/** The tokenlist */ // TODO PB: The name 'Structure' is very generic and should be changed to
...
public class Structure implements TokenConstants {
    ...
    public final void addToken(Token token) {
        ...
        if ((numberOfTokens > 0) && (token.getLine() < tokens[numberOfTokens - 1].getLine())
                && (token.file.equals(tokens[numberOfTokens - 1].file)))
